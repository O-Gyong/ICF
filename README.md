...
**🔗 바로 사용하기 — https://ohgyong.github.io/ICF/**

![대시보드](screenshots/dashboard.png)

> 아래 캡처 중 스킬·전술 화면은 실제 사용 중인 데이터이며, 선수 이름·경기 일정·장소가
> 나오는 화면(대시보드·일정·규칙·로스터)은 데모용 더미 데이터로 촬영했습니다.
...
배포된 앱은 GitHub Pages에서 바로 사용할 수 있습니다 — https://ohgyong.github.io/ICF/
